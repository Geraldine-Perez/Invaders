...
const app = {
    ...
    styles: [
        'black', 'white', 'plain', 'empty', 'light', 'highlight'
    ],
    paletteElem: '',
    choosenColor: 'plain',
    init: function() {
    ...
    handleClickOnPixel: function (event) {
        ...
        event.target.classList.remove('pixel--black', 'pixel--white', 'pixel--empty', 'pixel--plain', 'pixel--light', 'pixel--highlight');
        // alternative : 
    ...
    createPalette: function(){
        ...
        // On ajoute la phrase explicative pour l'utilisateur
        app.paletteElem.innerHTML = "<h3>Choose the color :</h3>";
    ...
    createForm: function () {
        app.createConfiguration('Grid size', 'number', true);
        app.createConfiguration('Pixel size', 'number', true);
        app.createConfiguration('Submit', 'submit', false);
    ...
    reStart: function () {
        ...
        buttonReStart.innerText = "Re start";
        buttonReStart.style.background = "rgb(251, 192, 72)";
        buttonReStart.style.padding = "0 2rem";
        buttonReStart.addEventListener('click', app.whiteBoard);
        configElem.appendChild(buttonReStart);
    },
  
    whiteBoard: function () {
        let invaderElem = document.querySelector('#invader');
        invaderElem.target.classList.toggle('pixel--white');
    }
  };
